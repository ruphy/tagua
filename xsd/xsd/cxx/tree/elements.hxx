  ...
  namespace cxx
  {
    namespace tree
    {
      ...
      struct flags
      {
        ...
        //
        //
        static const unsigned long dont_validate = 0x00000200UL;
        ...
        //
        static const unsigned long not_root = 0x01000000UL;
      ...
      public:
        ...
        _type (const type& t, flags f = 0, type* container = 0)
      ...
      private:
        ...
        struct dom_info_factory
        {
          ...
          create (const xercesc::DOMElement& e, type& n, flags f)
          {
            assert (f & flags::keep_dom);
          ...
          static std::auto_ptr<dom_info>
          create (const xercesc::DOMAttr& a, type& n, flags f)
          {
            assert (f & flags::keep_dom);
