...
#define XSD_CXX_PARSER_RO_STRING_HXX
  ...
  namespace cxx
  {
    namespace parser
    {
      ...
      public:
        ...
        {
          return compare (str.date (), str.size ());
        }
      ...
      {
        std::basic_string<C> tmp (str.data (), str.size ());
        return os << tmp;
      }
...
#include <xsd/cxx/parser/ro-string.txx>

#endif  // XSD_CXX_PARSER_RO_STRING_HXX
