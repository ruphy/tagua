...
theme.black_horse     = addShadow(fromChar("0x68", false, false))
...
theme.black_p_bishop  = addShadow(fromChar("0x41", false, true))
theme.black_p_horse   = addShadow(fromChar("0x48", false, true))
...
theme.white_horse     = addShadow(fromChar("0x68", true, false))
...
theme.white_p_bishop  = addShadow(fromChar("0x41", true, true))
theme.white_p_horse   = addShadow(fromChar("0x48", true, true))
