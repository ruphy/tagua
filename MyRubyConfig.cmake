...
IF (RUBY_EXECUTABLE)
    EXEC_PROGRAM(${RUBY_EXECUTABLE} 
      ...
      OUTPUT_VARIABLE EXPECTED_RUBY_LIBRARY_PATH)
    EXEC_PROGRAM(${RUBY_EXECUTABLE} 
      ARGS "-r rbconfig -e 'puts Config::CONFIG[%{rubyincludedir}] || Config::CONFIG[%{archdir}]'"
      OUTPUT_VARIABLE EXPECTED_RUBY_INCLUDE_PATH)
    EXEC_PROGRAM(${RUBY_EXECUTABLE} 
      ARGS "-r rbconfig -e 'puts Config::CONFIG[\"ruby_version\"]'" 
